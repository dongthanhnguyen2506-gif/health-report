...
const LOCATIONS = [
  {
    ...
    items: [
      {
        label: 'Tư vấn tại Ever Việt Nam',
        address: '155 Trần Huy Liệu, Phường 8, Quận Phú Nhuận, TP. HCM',
      },
    ],
  },
  {
...
export default function ConsultationBookingModal({ patientId, patientName, open, onClose }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    if (!timeSlot) {
      setError('Vui lòng chọn khung giờ mong muốn.')
      return
    }
    ...
    >
      <div
        style={{
          ...
          maxHeight: '94dvh',
          overflowY: 'auto',
          boxShadow: '0 -8px 48px rgba(10,20,40,0.22)',
        ...
        <div style={{ padding: '18px 24px 36px' }}>
          {submitted ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 15, lineHeight: 1.7, color: 'var(--gray-600)', marginBottom: 8 }}>
                Chúng tôi sẽ liên hệ Quý khách trong thời gian sớm nhất.
              </p>

              <p style={{ fontSize: 14, lineHeight: 1.65, color: 'var(--gray-400)', marginBottom: 28 }}>
            ...
            <>
              {patientName && (
                ...
                >
                  ...
                  <span>
                    Đặt lịch cho: <strong style={{ color: 'var(--navy)' }}>{patientName}</strong>
                  </span>
                </div>
              )}
                  ...
                  {BOOKING_CONFIG.timeSlots.map((slot) => (
                    <button
                      ...
                      style={{
                        padding: '14px 12px',
                        borderRadius: 12,
                        border: `2px solid ${timeSlot === slot ? 'var(--navy)' : '#e5e7eb'}`,
                        background: timeSlot === slot ? 'var(--navy)' : 'white',
                        color: timeSlot === slot ? 'white' : 'var(--gray-700)',
                        fontSize: 15,
              ...
              <div style={{ marginBottom: error ? 14 : 22 }}>
                ...
                <textarea
                  placeholder="Ví dụ: muốn hỏi thêm về chỉ số GGT và Acid Uric..."
                  value={note}
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: loading ? 'none' : '0 8px 24px rgba(15,30,53,0.22)',
                    transition: 'all 0.15s',
                    touchAction: 'manipulation',
                  }}
                >
